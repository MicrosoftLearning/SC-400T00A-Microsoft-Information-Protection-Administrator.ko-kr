...
1. **정책 적용할 위치 선택** 영역에서 **Exchange 사서함**, **SharePoint 클래식 및 통신 사이트**, **OneDrive 계정** 및 **Microsoft 365 그룹 사서함 & 사이트가** 선택되어 있는지 확인한 후 **다음**을 선택합니다.
