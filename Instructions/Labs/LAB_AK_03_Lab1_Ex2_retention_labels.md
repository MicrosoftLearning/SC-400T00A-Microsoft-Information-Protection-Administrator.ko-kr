...
1. 다음 정보를 입력합니다.
    ...
    - **Exchange 사서함** 위치 - **상태**: 켜기
    - **SharePoint 클래식 및 통신 사이트** 위치 - **상태**: 켜기
    - **OneDrive 계정** 위치 - **상태**: 켜기
    - **Microsoft 365 그룹 사서함 & 사이트** 위치 - **상태**: OFF  
...
1. **정책을 적용할 위치 선택** 페이지에서 **Exchange 사서함, SharePoint 클래식 및 통신 사이트, OneDrive 계정 및 Microsoft 365 그룹 사서함 & 사이트에** 대한 **옵션을 켜고** **다음**을 선택합니다.
...
1. 강조 표시된 문서의 경우 가로 **...** 단추를 선택합니다.  **추가** 옵션 위에 마우스를 올려 놓습니다.
