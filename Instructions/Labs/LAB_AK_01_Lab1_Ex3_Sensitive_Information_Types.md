...
1. 위쪽 창에서 **중요한 정보 유형**을 선택합니다.  
   ...
   >**힌트:** **중요한 정보 유형**이 Purview 포털에 표시되지 않으면 이전 랩의 준수 관리 Joni의 권한 업데이트가 브라우저에서 업데이트되지 않은 것일 수 있습니다.  로그아웃했다가 JoniS로 로그인해야 할 수 있습니다.
...
1. 왼쪽 창에서 **Teams & 그룹을** 확장한 다음 **활성 팀 & 그룹을** 선택합니다.
